...
- foundation-test：测试用例，前提是先根据数据库设计文档建立好数据库。比如[测试添加用户接口](https://github.com/wuda0112/foundation/blob/master/foundation-test/src/test/java/com/wuda/foundation/user/test/UserManagerTest.java)
