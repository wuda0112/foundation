...
public class NotificationInstanceSendHistoryDao extends DAOImpl<NotificationInstanceSendHistoryRecord, com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory, ULong> {

    /**
     * Create a new NotificationInstanceSendHistoryDao without any configuration
     */
    public NotificationInstanceSendHistoryDao() {
        super(NotificationInstanceSendHistory.NOTIFICATION_INSTANCE_SEND_HISTORY, com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory.class);
    }
    ...
    public NotificationInstanceSendHistoryDao(Configuration configuration) {
        super(NotificationInstanceSendHistory.NOTIFICATION_INSTANCE_SEND_HISTORY, com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory.class, configuration);
    }

    @Override
    public ULong getId(com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory object) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchRangeOfNotificationInstanceSendHistoryId(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchByNotificationInstanceSendHistoryId(ULong... values) {
     ...
     */
    public com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory fetchOneByNotificationInstanceSendHistoryId(ULong value) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchRangeOfNotificationInstanceContentId(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchByNotificationInstanceContentId(ULong... values) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchRangeOfSendTime(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchBySendTime(LocalDateTime... values) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchRangeOfSenderType(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchBySenderType(UByte... values) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchRangeOfSenderIdentifier(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchBySenderIdentifier(ULong... values) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchRangeOfReceiverType(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchByReceiverType(Byte... values) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchRangeOfReceiverIdentifier(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchByReceiverIdentifier(ULong... values) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchRangeOfIsDeleted(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.core.notification.impl.jooq.generation.tables.pojos.NotificationInstanceSendHistory> fetchByIsDeleted(ULong... values) {
