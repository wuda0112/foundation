...
public interface PermissionGrantManager {
     ...
     * clear assignment与{@link AllowOrDeny#EXCLUSION}的区别,clear assignment是完全清除掉实体之间的关联,清理后,
     * 实体之间相互独立,没有了任何关联信息.{@link AllowOrDeny#EXCLUSION}是实体之间建立关联,只是这种关联表明{@link Subject}
     ...
     * <ul>
     * <li>如果想排除掉文件夹b和c呢,这时只需要为用户A分配文件夹b,但是使用{@link AllowOrDeny#EXCLUSION}即可排除.</li>
     ...
     */
    boolean subjectTargetAssigned(Subject subject, Target target, AllowOrDeny allowOrDeny);
}
