...
public class Item extends SchemaImpl {

    private static final long serialVersionUID = 1520960630;
     ...
     */
    public final com.wuda.foundation.item.impl.jooq.generation.tables.Item ITEM_ = com.wuda.foundation.item.impl.jooq.generation.tables.Item.ITEM_;
    ...
    public final List<Table<?>> getTables() {
        return Arrays.<Table<?>>asList(
            com.wuda.foundation.item.impl.jooq.generation.tables.Item.ITEM_,
