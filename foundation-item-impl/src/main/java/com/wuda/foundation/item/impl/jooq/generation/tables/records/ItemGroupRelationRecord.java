...
public class ItemGroupRelationRecord extends UpdatableRecordImpl<ItemGroupRelationRecord> implements Record8<ULong, ULong, ULong, LocalDateTime, ULong, LocalDateTime, ULong, ULong> {
    ...
    /**
     * Getter for <code>foundation_item.item_group_relation.id</code>.
     */
    public ULong getId() {
        return (ULong) get(0);
    }
    ...
    /**
     * Setter for <code>foundation_item.item_group_relation.item_id</code>.
     */
    ...
    /**
     * Getter for <code>foundation_item.item_group_relation.item_id</code>.
     */
    ...
    public Field<ULong> field1() {
        return ItemGroupRelation.ITEM_GROUP_RELATION.ID;
    }

    @Override
    public Field<ULong> field2() {
        return ItemGroupRelation.ITEM_GROUP_RELATION.ITEM_ID;
    }
    ...
    @Override
    public ItemGroupRelationRecord value1(ULong value) {
        setId(value);
        return this;
    }

    @Override
    public ItemGroupRelationRecord value2(ULong value) {
        setItemId(value);
        return this;
    }
    ...
    /**
     * Create a detached ItemGroupRelationRecord
     */
    public ItemGroupRelationRecord() {
