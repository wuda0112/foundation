...
public class FoundationNotification extends SchemaImpl {
    ...
    private static final long serialVersionUID = -1210418290;
     ...
     * 通知定义所属的组
     */
    public final NotificationDifinitionGroupRelation NOTIFICATION_DIFINITION_GROUP_RELATION = NotificationDifinitionGroupRelation.NOTIFICATION_DIFINITION_GROUP_RELATION;
    ...
    public final List<Table<?>> getTables() {
        return Arrays.<Table<?>>asList(
            ...
            NotificationDifinitionGroupRelation.NOTIFICATION_DIFINITION_GROUP_RELATION,
