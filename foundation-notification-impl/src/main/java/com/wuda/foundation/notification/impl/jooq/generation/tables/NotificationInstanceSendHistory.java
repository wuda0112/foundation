...
public class NotificationInstanceSendHistory extends TableImpl<NotificationInstanceSendHistoryRecord> {
     ...
     */
    public final TableField<NotificationInstanceSendHistoryRecord, LocalDateTime> SEND_TIME = createField(DSL.name("send_time"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");
     ...
     */
    public final TableField<NotificationInstanceSendHistoryRecord, ULong> IS_DELETED = createField(DSL.name("is_deleted"), org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");
