...
public class NotificationInstanceTraceDao extends DAOImpl<NotificationInstanceTraceRecord, com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace, ULong> {

    /**
     * Create a new NotificationInstanceTraceDao without any configuration
     */
    public NotificationInstanceTraceDao() {
        super(NotificationInstanceTrace.NOTIFICATION_INSTANCE_TRACE, com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace.class);
    }
    ...
    public NotificationInstanceTraceDao(Configuration configuration) {
        super(NotificationInstanceTrace.NOTIFICATION_INSTANCE_TRACE, com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace.class, configuration);
    }

    @Override
    public ULong getId(com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace object) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfNotificationInstanceTraceId(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByNotificationInstanceTraceId(ULong... values) {
     ...
     */
    public com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace fetchOneByNotificationInstanceTraceId(ULong value) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfNotificationInstanceContentId(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByNotificationInstanceContentId(ULong... values) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfObserverType(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByObserverType(UByte... values) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfObserverIdentifier(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByObserverIdentifier(ULong... values) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfRead(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByRead(Boolean... values) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfReadTime(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByReadTime(LocalDateTime... values) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfCreateTime(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByCreateTime(LocalDateTime... values) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfCreateUserId(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByCreateUserId(ULong... values) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfLastModifyTime(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByLastModifyTime(LocalDateTime... values) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfLastModifyUserId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByLastModifyUserId(Long... values) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchRangeOfIsDeleted(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.wuda.foundation.notification.impl.jooq.generation.tables.pojos.NotificationInstanceTrace> fetchByIsDeleted(ULong... values) {
