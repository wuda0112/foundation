...
public class NotificationCategoryRecord extends UpdatableRecordImpl<NotificationCategoryRecord> implements Record9<ULong, ULong, String, String, LocalDateTime, ULong, LocalDateTime, ULong, ULong> {

    private static final long serialVersionUID = 1819754512;
    ...
    @Override
    public NotificationCategoryRecord value3(String value) {
        setName(value);
        return this;
    }

    @Override
    public NotificationCategoryRecord value4(String value) {
        setDescription(value);
        return this;
    }

    @Override
    public NotificationCategoryRecord value5(LocalDateTime value) {
        setCreateTime(value);
        return this;
    }

    @Override
    public NotificationCategoryRecord value6(ULong value) {
    ...
    @Override
    public NotificationCategoryRecord value9(ULong value) {
        setIsDeleted(value);
        return this;
    }

    @Override
    public NotificationCategoryRecord values(ULong value1, ULong value2, String value3, String value4, LocalDateTime value5, ULong value6, LocalDateTime value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NotificationCategoryRecord(ULong notificationCategoryId, ULong parentNotificationCategoryId, String name, String description, LocalDateTime createTime, ULong createUserId, LocalDateTime lastModifyTime, ULong lastModifyUserId, ULong isDeleted) {
        super(NotificationCategory.NOTIFICATION_CATEGORY);
