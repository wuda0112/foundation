...
public abstract class AbstractStoreManager implements StoreManager {
    ...
    @Override
    public long createStoreGeneral(CreateStoreGeneral createStoreGeneral, KeyGenerator<Long> keyGenerator, Long opUserId) {
        ExtObjects.requireNonNull(createStoreGeneral, keyGenerator, opUserId);
        return createStoreGeneralDbOp(createStoreGeneral, keyGenerator, opUserId);
    }
     ...
     * @return 基本信息的ID
     */
    protected abstract long createStoreGeneralDbOp(CreateStoreGeneral createStoreGeneral, KeyGenerator<Long> keyGenerator, Long opUserId);
