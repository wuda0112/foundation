...
public class User extends SchemaImpl {
    ...
    private static final long serialVersionUID = -1870657995;
     ...
     */
    public final com.wuda.foundation.user.impl.jooq.generation.tables.User USER_ = com.wuda.foundation.user.impl.jooq.generation.tables.User.USER_;
    ...
    public final List<Table<?>> getTables() {
        return Arrays.<Table<?>>asList(
            ...
            Role.ROLE,
            com.wuda.foundation.user.impl.jooq.generation.tables.User.USER_,
